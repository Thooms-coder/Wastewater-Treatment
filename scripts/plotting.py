...
DISPLAY_LABELS = {
    ...
    "ferric_solution_lbs_per_day_measured": "Ferric solution feed measured (lb/day)",
    "ferric_active_lbs_per_day_measured": "Ferric active feed measured (lb/day)",
    ...
    "hcl_solution_lbs_per_day_measured": "HCl solution feed measured (lb/day)",
    "hcl_active_lbs_per_day_measured": "HCl active feed measured (lb/day)",
    "hcl_active_mg_per_L_reported": "HCl dose intensity reported (mg/L)",
    "hcl_dosage_mg_per_L_measured": "HCl dosage measured (mg/L)",
    "bio_centrate_ph_su": "Centrate pH",
    "bio_centrate_alkalinity_mg_l": "Centrate alkalinity (mg/L)",
    "bio_filtrate_ph_su": "Filtrate pH",
    "bio_filtrate_alkalinity_mg_l": "Filtrate alkalinity (mg/L)",
    "bio_biosolids_centrate_ortho_p_mg_l": "Centrate ortho P (mg/L)",
    "bio_biosolids_filtrate_ortho_p_mg_l": "Filtrate ortho P (mg/L)",
    "bio_biocake_struvite_observation_no_1650_yes_3500": "Biocake struvite observation code",
